  ...
  return (
    <section className="grid min-h-[calc(100vh-3.5rem)] gap-6 lg:grid-cols-[1fr_0.86fr] lg:items-stretch">
      <div className="glass-panel relative overflow-hidden rounded-[2.4rem] p-7 text-white md:p-10 xl:p-14">
        <div className="absolute right-8 top-8 hidden font-[var(--ethiopic)] text-[11rem] font-black leading-none text-white/[0.04] md:block">ፊ</div>
        ...
        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
          <button onClick={() => onStart("dashboard")} className="inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl bg-[#58cc02] px-6 text-sm font-black text-black transition hover:-translate-y-0.5 hover:brightness-110">
            Start learning
            <ArrowRight size={18} />
          </button>
