      ...
      <section className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="grid content-start gap-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            {signedIn ? (
              <div className="rounded-[1.5rem] border border-black bg-black p-5 text-white">
                <Cloud size={24} />
                <h2 className="mt-5 text-2xl font-black">Cloud saved</h2>
                <p className="mt-2 text-sm font-bold text-white/55">Progress follows your Google account.</p>
                <button onClick={onAuth} className="mt-5 text-sm font-black text-white/70 underline underline-offset-4 hover:text-white">
                  Sign out
                </button>
              </div>
            ) : (
